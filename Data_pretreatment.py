...
def Produce_split_features(data_path,script_path):
    ...
    Output:
        None
    """
    config_path_list = list(i for i in glob("{}/*".format(data_path)) if 1000 < int(os.path.basename(i)) )
...
if __name__ == "__main__":
    ...
    config_folder_path = "/DATA/users/yanghe/projects/NeuralNetwork_PES/Neural_network/NaCl_BPNN/data/Split_data"

    TRIAN_INPUT_PATH = "/DATA/users/yanghe/projects/NeuralNetwork_PES/Neural_network/NaCl_BPNN/data/TrainInput"
    ...
    """
    Data_assemble.Core_train_data(  config_folder_path= config_folder_path,
                                    config_list= train_config_name,
                                    features_list=["HS_Nn","HS_Cc","EC_NN","EC_NC","EC_Nn","EC_Nc","EC_CN","EC_CC","EC_Cn","EC_Cc"],
                                    save_folder_path=TRIAN_INPUT_PATH,
                                    reassemble=True)
    Data_assemble.Core_valid_data(  config_folder_path= config_folder_path,
                                    config_list= valid_config_name,
                                    features_list=["HS_Nn","HS_Cc","EC_NN","EC_NC","EC_Nn","EC_Nc","EC_CN","EC_CC","EC_Cn","EC_Cc"],
                                    save_folder_path=VALID_INPUT_PATH,
                                    rescale_file_path=TRIAN_INPUT_PATH,
                                    reassemble=True)
    Data_assemble.Shell_train_data( config_folder_path= config_folder_path,
                                    config_list= train_config_name,
                                    features_list=["HS_nN","HS_cC","EC_nN", "EC_nC", "EC_nn","EC_nc", "EC_cN", "EC_cC", "EC_cn", "EC_cc", "SH_nn", "SH_nc", "SH_cn", "SH_cc"],
                                    save_folder_path=TRIAN_INPUT_PATH,
                                    reassemble=True)
    Data_assemble.Shell_valid_data( config_folder_path= config_folder_path,
                                    config_list= valid_config_name,
                                    features_list=["HS_nN","HS_cC","EC_nN", "EC_nC", "EC_nn","EC_nc", "EC_cN", "EC_cC", "EC_cn", "EC_cc", "SH_nn", "SH_nc", "SH_cn", "SH_cc"],
                                    save_folder_path=VALID_INPUT_PATH,
                                    rescale_file_path=TRIAN_INPUT_PATH,
                                    reassemble=True)
    """
    Data_assemble.Core_valid_data(  config_folder_path= "/DATA/users/yanghe/forall/NaCl_weight/Benchmark/",
                                    config_list= ["Core1080"],
                                    features_list=["HS_Nn","HS_Cc","EC_NN","EC_NC","EC_Nn","EC_Nc","EC_CN","EC_CC","EC_Cn","EC_Cc"],
                                    save_folder_path="/DATA/users/yanghe/forall/NaCl_weight/Benchmark/Core1080/Input/",
                                    rescale_file_path="/DATA/users/yanghe/forall/NaCl_weight/Core/",
                                    reassemble=True)
    exit()
    Data_assemble.Shell_valid_data( config_folder_path = "/DATA/users/yanghe/projects/NeuralNetwork_PES/Neural_network/NaCl_BPNN/data/",
                                    config_list= ["NaCl1080"],
                                    features_list=["HS_nN","HS_cC","EC_nN", "EC_nC", "EC_nn","EC_nc", "EC_cN", "EC_cC", "EC_cn", "EC_cc", "SH_nn", "SH_nc", "SH_cn", "SH_cc"],
                                    save_folder_path="/DATA/users/yanghe/projects/NeuralNetwork_PES/Neural_network/NaCl_BPNN/data/NaCl1080/Input/",
                                    rescale_file_path="/DATA/users/yanghe/projects/NeuralNetwork_PES/Neural_network/NaCl_BPNN/data/TrainInput",
                                    reassemble=True)
